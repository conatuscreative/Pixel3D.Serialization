...
{
    static class BinaryReadOpCodeExtensions
    {
        static OpCode[] singleByteOpCodes = new OpCode[0x100];
        static OpCode[] multiByteOpCodes = new OpCode[0x100];
        ...
        {
            int b = br.ReadByte();
            OpCode opCode = (b == 0xFE ? multiByteOpCodes[br.ReadByte()] : singleByteOpCodes[b]);
        ...
        public static int ReadIndexOperandLdarg(this BinaryReader br, ushort opCodeValue)
        {
            switch(opCodeValue)
            {
                case OpCodeValues.Ldarg: return (int)br.ReadUInt16();
                ...
                case OpCodeValues.Ldarg_S: return (int)br.ReadByte();
        ...
        public static int ReadIndexOperandLdloc(this BinaryReader br, ushort opCodeValue)
        {
            switch(opCodeValue)
            {
                case OpCodeValues.Ldloc: return (int)br.ReadUInt16();
                ...
                case OpCodeValues.Ldloc_S: return (int)br.ReadByte();
